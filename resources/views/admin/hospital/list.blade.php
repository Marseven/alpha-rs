                                            ...
                                            <tr>
                                                    ...
                                                    <div class="media d-flex align-items-center">
                                                        <div class="avatar avatar-xl mr-2">
                                                            <img class="rounded-circle img-fluid"
                                                                src="{{ asset($hospital->picture_1) }}" alt=""
                                                                width="30">
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#sickModalView{{ $hospital->id }}"><i
                                                            class="fa fa-medkit"></i></button>
                                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#cardModalView{{ $hospital->id }}"><i
                                                            class="fa fa-eye"></i></button>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#cardModal{{ $hospital->id }}"><i
                                                            class="fa fa-edit"></i></button>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#cardModalCenter{{ $hospital->id }}">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            <div class="profile-photo">
                                <img src="{{ asset($hospital->picture_1) }}" width="100"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabelOne">
                            Maladies Traitées
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#sickModal{{ $hospital->id }}"><i class="fa fa-edit"></i></button>
                        </h5>
                    </div>
                    <div class="modal-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-top-0">
                                                            <div class="form-check ">
                                                                <input type="checkbox" checked name="{{ $sick->label }}"
                                                                    class="form-check-input" id="customCheckOne" disabled>
                                                                <label class="form-check-label"
                                                                    for="customCheckOne"></label>
                                                            </div>
                                                        </td>
                                                        <input type="hidden" name="hospital"
                                                            value="{{ $hospital->id }}">
                                                        <input type="hidden" name="{{ $sick->label }}-sick"
                                                            value="{{ $sick->id }}">
                                                    </tr>
                                                @endif
                                            @endforeach
                                    ...
                                    <tbody>
                                        @foreach ($sicks as $sick)
                                            <tr>
                                                ...
                                                <td class="border-top-0">
                                                    <div class="form-check ">
                                                        <input type="checkbox" name="sick-{{ $sick->id }}"
                                                ...
                                                <input type="hidden" name="{{ $sick->id }}-sick"
                                                    value="{{ $sick->id }}">
                                            </tr>
                                        @endforeach
                                    </tbody>
