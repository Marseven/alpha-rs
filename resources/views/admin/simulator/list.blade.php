                                ...
                                <tbody>
                                    ...
                                    @foreach($simulators as $simulator)
                                        <tr>
                                            <td>
                                                <div class="media d-flex align-items-center">
                                                    <div class="avatar avatar-xl mr-2">
                                                        <img class="rounded-circle img-fluid" src="{{asset($simulator->picture)}}" alt="" width="30">
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>{{  $status }}</td>
                                            <td>
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#cardModalView{{$simulator->id}}" ><i class="fa fa-eye"></i></button>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cardModal{{$simulator->id}}" ><i class="fa fa-edit"></i></button>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cardModalCenter{{$simulator->id}}">
            ...
            <div class="text-center">
                <div class="row">
                    <div class="col-4 pt-3 pb-3 border-right">
                        <h3 class="mb-1">{{$simulator->price_min}}</h3><span>Prix Min</span>
                    </div>
                    <div class="col-4 pt-3 pb-3 border-right">
                        <h3 class="mb-1">{{$simulator->price_max}}</h3><span>Prix Max</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-body">
          <form action="{{ url('admin/simulator/'.$simulator->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="price_min" value="{{$simulator->price_min}}">
            </div>

            <div class="mb-3">
                <label for="price_promo" class="col-form-label">Prix Max</label>
                <input type="text" class="form-control" name="price_max" value="{{$simulator->price_max}}">
            </div>
