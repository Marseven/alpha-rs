        ...
        <div class="row">
            ...
            <div class="container">
                <div class="row text-center">
                  <div class="col-6">
                    <h3 class="mb-1">{{$country->label}}</h3><span>Destination</span>
                  </div>
                  <div class="col-6">
                    <h3 class="mb-1">{{$service->label}}</h3><span>{{$service->price}} XAF</span>
                  </div>
                </div>
                <br><br>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach($simulators as $simulator)
                            <tr>
                                ...
                                <td>{{$simulator->price_min}} XAF</td>
                                <td>{{$simulator->price_max}} XAF</td>
                            </tr>
                            @php
                        ...
                        <tr>
                            ...
                            <td><strong>{{$total1}} XAF</strong></td>
                            <td><strong>{{$total2}} XAF</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
