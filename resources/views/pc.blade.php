            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="bread-inner">
                        <h1 class="heading-font">Politique de Confidentialités</h1>
                        <ul class="breadcrumb">
                            <li>
                                <a href="{{ route('home') }}">
                                    <p>Accueil</p>
                        ...
                        <div class="tab-pane show active" id="tab1" role="tabpanel" aria-labelledby="tab1">
                            <div class="faq-inner" style="overflow-y: scroll">
                                ...
                                <p>  Les données personnelles recueillies par le site internet
                                    ...
                                    ultérieurement d’une manière incompatible avec ces fins ; conformément aux 45 et
                                    suivants de la loi relative à la protection des données à caractère personnel
                                     Adéquates, pertinentes et limitées à ce qui est nécessaire dans le cadre des finalités
                                    pour lesquelles elles sont traitées ;
                                     Exactes, et si nécessaires tenues à jour. Toutes les mesures raisonnables seront
                                    prises pour corriger des données incorrectes au regard de la finalité pour laquelle
                                    celles-ci sont collectées ;
                                    ...
                                     Traitées d’une façon qui garantit la sécurité de celles-ci, y compris en ce qui
                                    concerne le traitement non-autorisé ou illicite, la perte ou la destruction de ces
                                    données, accidentelle ou volontaire.

                                    Le traitement des données collectées n’est licite que si au moins l’une des conditions
                                    suivantes est remplie :

                                     La personne concernée par les données à consenti au traitement de celles-ci pour une
                                    ...
                                     Adresse mail
                                     Lieu de résidence
                                     Pièce d’identité valable (passeport, carte nationale d’identité, etc.)

                                    Ces données sont recueillies dont le but de contacter l’Utilisateur qui souscrit aux
                                    ...
                                     Tiers : Les données récoltées peuvent être transmises aux tiers uniquement à des fins
                                    prévues par la présente Politique. Il s’agit entre autres de la transmission de votre
                                    état civil afin de procéder à des réservations ou des achats (hospitalisation,
                                    billetteries, etc.)

                                    Par ailleurs, les données personnelles collectées pourront être partagées :
                                     Si l’entreprise Relief Services y est contrainte par la loi
                                     Si les informations sont requises pour toute procédure judiciaire
                                     Afin de protéger les droits légaux de Relief Services
                                    ...
                                    Rue Pecqueur, Derrière l’immeuble premium, BP : 2280
                                    Numéro de téléphone +24176555187
                                    Adresse e-mail : reliefservices21@gmail.com.
