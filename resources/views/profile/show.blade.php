                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#passwordModal" >Réinitialiser le Mot de passe</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-6 mb-3">
                      <div class="card h-100">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#folderModal">Créer</button>
                        </div>
                        <div class="card-body">
                                        ...
                                        @if ($user->folders->count() > 0)
                                            @foreach($user->folders as $folder)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="modal" data-target="#folderModalView{{$folder->id}}" ><i class="fa fa-eye"></i></a>
                                                        <a data-toggle="modal" data-target="#folderPay{{$folder->id}}" ><i class="fa fa-cash-o"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
...
@if ($user->folders->count() > 0)
    ...
    <div class="modal fade" id="folderModalView{{$folder->id}}" >
        ...
        <div class="modal-content">
            ...
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#folderPay{{$folder->id}}" >Payer</button>
            </div>
        </div>
        </div>
    </div>
