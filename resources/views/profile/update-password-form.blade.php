        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Réinitialiser mon mot de passe</a>
                    <!--end::Item-->
                </div>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                <div class="symbol-label" style="background-image:url('{{asset($user->picture)}}')"></div>
                        ...
                        <br>
                         ...
                         <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{url('/user/'.$user->id)}}" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{url('/userpassword/'.$user->id)}}" class="navi-link py-4 active">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted font-weight-bold font-size-sm mt-1">Réintialiser le mot de passe</span>
                        </div>
                        <form class="form" method="POST" action="{{url('/userpassword/'.$user->id)}}">
                            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-custom alert-light-danger fade show mb-10" role="alert">
                                ...
                                <div class="alert-text font-weight-bold">
                                    Votre mot de passe doit contenir au moins 8 caractères ( au moins un chiffre, une lettre et carcatère spécial) !
                                </div>
