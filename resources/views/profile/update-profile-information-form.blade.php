        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Modifier mon Profil</a>
                    <!--end::Item-->
                </div>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                <div class="symbol-label" style="background-image:url('{{asset($user->picture ? $user->picture : 'media/users/blank.png')}}')"></div>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="{{route('profil')}}" class="navi-link py-4">
                                    ...
                                    <span class="navi-text font-size-lg">Mon Profil</span>
                                </a>
                            </div>
                            <div class="navi-item mb-2">
                                <a href="{{url('/user/'.$user->id)}}" class="navi-link py-4 active">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                                    ...
                                    <span class="navi-text font-size-lg">Informations Personnelles</span>
                                </a>
                            </div>
                            <div class="navi-item mb-2">
                                <a href="{{url('/userpassword/'.$user->id)}}" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                                    ...
                                    <span class="navi-text font-size-lg">Changer le mot de passe</span>
                                </a>
                            </div>
                        </div>
                        <!--end::Nav-->
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted font-weight-bold font-size-sm mt-1">Mettre à jour tes informations</span>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <h5 class="font-weight-bold mb-6">Identité</h5>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{asset('media/users/blank.png')}})">
                                        <div class="image-input-wrapper" style="background-image: url('{{asset($user->picture ? $user->picture : 'media/users/blank.png')}}')"></div>
                                    ...
                                    <span class="form-text text-muted">Type de fichiers accepté: png, jpg, jpeg.</span>
                                </div>
                            </div>
                            <div class="form-group row">
