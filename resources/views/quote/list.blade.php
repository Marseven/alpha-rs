                                ...
                                <tr class="border-b border-line-subtle last:border-0 hover:bg-canvas">
                                    ...
                                    <td class="px-6 py-3.5 text-right">
                                        <div class="inline-flex items-center justify-end gap-4">
                                            @if ($quote->devis)
                                                <a href="{{ route('files.quote', [$quote, 'devis']) }}" class="hidden items-center gap-1.5 text-sm font-semibold text-ink-muted transition-colors hover:text-primary-600 sm:inline-flex" title="Télécharger le devis">
                                            ...
                                            @endif
                                            <a href="{{ url('quote/payment/' . $quote->id) }}" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-700">
                                                Voir le devis
