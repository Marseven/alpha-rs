...
<head>
    ...
    <title>Health Express - Administration </title>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{asset($user->picture ? $user->picture : 'images/blank.png')}}" width="20" alt=""/>
                                </a>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<a href="{{url('admin/list-hospitals')}}"><div class="plus-box">
