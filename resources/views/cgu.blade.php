                    ...
                    <div class="tab-content" id="faq-tab-content" style="overflow-y: scroll">
                        <div class="tab-pane show active" id="tab1" role="tabpanel" aria-labelledby="tab1">
                            <div class="faq-inner">
                                ...
                                <h1 style="font-family: 'Poppins', sans-serif; text-align: center;line-height: 40px;">
                                    Conditions générales d'utilisation <br>
                                    En vigueur au 24/10/2022</h1>
                                <br><br>
                                ...
                                Accepter les termes et conditions d’utilisation ». A cet effet, l’accès aux services
                                proposés par www.reliefservices.net conditionne l’Utilisateur à accepter expressément
                                les CGU stipulées ci-après.
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">Article 1 : Les mentions légales</h2>
                                <br><br>
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 2 : Accès au site</h2>
                                <br><br>
                                ...
                                <ul>
                                    ...
                                    <li> Assistance Aéroportuaire</li>
                                    <li> Billetterie</li>
                                </ul>

                                L’Utilisateur doit bénéficier d’un accès internet pour pouvoir accéder à
                                www.reliefservices.net ; l’accès au site est gratuit. Toutefois, sont à la charge de
                                l’Utilisateur, le matériel utilisé (ordinateur, smartphone, tablette numérique).
                                Un Utilisateur non enregistré ne peut avoir accès aux services proposés par le site.
                                Tout souscription aux services conduit l’Utilisateur à remplir le formulaire
                                d’enregistrement. En acceptant de s’inscrire aux services proposés, l’Utilisateur
                                s’engage à fournir des informations exactes. Il s’agit entre autres de son adresse mail,
                                ses coordonnées et son état civil.

                                L’Utilisateur reconnait qu’un événement dû à un cas de force majeure peut altérer le
                                fonctionnement du site. Aussi, tout événement du genre dont la conséquence entrainerait
                                un dysfonctionnement du serveur et, sous réserve de toute interruption ou modification
                                en cas de maintenance, n'engage pas la responsabilité de www.reliefservices.net .
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 3 : Collecte des données</h2>
                                <br><br>
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 4 : Propriété intellectuelle</h2>
                                <br><br>
                                ...
                                l'autorisation préalable de www.reliefservices.net pour toute reproduction ou
                                publication des différents contenus, s'engage à une utilisation strictement privée.
                                Aussi, toute représentation totale ou partielle de ce site par quelque procédé que ce
                                soit, sans l’autorisation expresse de l’exploitant du site Internet constituerait une
                                contrefaçon. Par ailleurs, l’Utilisateur qui reproduit, copie ou publie le contenu
                                protégé doit citer l’auteur et sa source. Il en va de soi pour le respect de la
                                propriété intellectuelle.

                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 5 : Liens hypertextes</h2>
                                <br><br>
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 6 : Cookies</h2>
                                <br><br>
                                ...
                                d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Ce
                                fichier contient un identifiant unique, généré aléatoirement.
                                L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut
                                s’installer automatiquement sur son logiciel de navigation. L’information contenue dans
                                les cookies est utilisée pour améliorer le site www.reliefservices.net. En naviguant sur
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 7 : Responsabilité</h2>
                                <br><br>
                                ...
                                contractuelle. Malgré des mises à jour régulières, le site www.reliefservices.net ne
                                peut être tenu responsable de la modification des dispositions administratives et
                                juridiques survenant après la publication.
                                De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation
                                de l’information contenue dans ce site. En cas d’inscription, l'Utilisateur s'assure de
                                garder son mot de passe secret. Toute divulgation du mot de passe, quelle que soit sa
                                forme, est interdite. Il assume les risques liés à l'utilisation de son identifiant et
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 8 : Publication par l’Utilisateur
                                </h2>
                                <br><br>
                                ...
                                Dans ce cas d’espèce, l’Utilisateur s’engage à respecter les règles de bonne conduite de
                                l’internet et celles relatives au droit en vigueur. Le site peut exercer une modération
                                sur les commentaires et se réserve le droit de refuser leur mise en ligne, sans avoir à
                                s’en justifier auprès de l’Utilisateur. Relief Services s'engage à faire figurer le nom
                                de l’Utilisateur à proximité de chaque utilisation de sa publication.
                                Tout contenu mis en ligne par l'Utilisateur est de sa seule responsabilité. Ce dernier
                                s'engage à ne pas mettre en ligne des contenus pouvant porter atteinte aux intérêts de
                                ...
                                <br><br>
                                <h2 style="font-family: 'Poppins', sans-serif;">ARTICLE 9 : Droit applicable et juridiction
                                    compétente</h2>
                                <br><br>
