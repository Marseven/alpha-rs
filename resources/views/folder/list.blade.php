    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
                <!--begin::Title-->
                <h2 class="text-white font-weight-bold my-2 mr-5">Liste des demandes de carte prépayée</h2>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Demandes de Carte Prépayée</a>
                    <!--end::Item-->
                </div>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">Liste de demandes de cartes prépayées
                ...
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="{{route('request-card')}}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
                    ...
                    <tbody>
                        @foreach($request_cards as $request_card)
                            <tr>
                                ...
                                <td>{{$request_card->account_orabank}}</td>
                                <td>{{$request_card->type_prepaid_card}}</td>
                                @php
