                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="tg-slidercontent">
                                <h6 class="pogoSlider-slide-element" data-in="slidedown" data-duration="800"
                                    data-delay="500">Health Express</h6>
                ...
                <div class="col-lg-7 col-md-8 text-left pl0">
                    <div class="about-cont">
                        ...
                        <p>
                            ...
                            Health Express est solution numérique permettant de faciliter la prise en charge des patients
                            souhaitant se faire soigner à l’étranger dans le cadre d’une Evacuation Sanitaire ou d’un bilan
                            médical de santé.
                            Notre solution numérique Health Express vous permettra de Gagnez en temps dans vos démarches
                    ...
                    <div class="col-md-4">
                        <div class="service-inner text-center">
                            ...
                            <h5>{{ $service->label }} <br><br> <span
                                    class="badge badge-pill badge-info">{{ $service->price }} XAF</span></h5>
