...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "../images/Logo-RSA.png");
			jQuery(".nav-header .logo-compact").attr("src", "../images/Alpha-text.png");
			jQuery(".nav-header .brand-title").attr("src", "../images/Alpha-text.png");
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "../images/LogoWhite.png");
			jQuery(".nav-header .logo-compact").attr("src", "../images/Alpha-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "../images/Alpha-text-white.png");
		}
    });
